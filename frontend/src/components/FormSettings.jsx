  ...
  return (
    <Container sx={{padding:2}}>
      <form onSubmit={handleFormChange}>
        <Box sx={{padding:2,display:'flex',flexDirection:'row'}}>
              <Container sx={{display:'flex',flexDirection:'column',gap:4}}>
                  <div>
                    ...
                    <select id="selectAlign" name='align' value={settingsData.align} onChange={handleSettingsChange}>
                  ...
                  <div>
                    ...
                    <select id="selectTheme" name='theme' value={settingsData.theme} onChange={handleSettingsChange}>
        ...
        <Container sx={{display:'flex',flexDirection:'row',justifyContent:'space-between',marginTop:2}}>
              <Button type="reset" variant='outlined' color='error' onClick={resetForm}>Reset</Button>
